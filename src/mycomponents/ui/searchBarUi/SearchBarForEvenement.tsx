import { EventDataType, requestToGetEventDataBySearchValue } from "@/fakeData";
...
function SearchBarForEvenement({
  placeholder,
  setEventData,
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetEventDataBySearchValue(searchValue);
      setEventData([...data]);
...
export default SearchBarForEvenement;
