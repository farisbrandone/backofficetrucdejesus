import { requestToGetMembreDataBySearchValue } from "@/fakeData";
...
function SearchBarForMembre({
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetMembreDataBySearchValue(searchValue);
      setMemberData([...data]);
...
export default SearchBarForMembre;
