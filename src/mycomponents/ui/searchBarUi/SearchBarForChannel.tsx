import {
  ChannelPageDataType,
  requestToGetChannelDataBySearchValue,
} from "@/fakeData";
...
function SearchBarForChannel({
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetChannelDataBySearchValue(searchValue);
      setChannelData([...data]);
