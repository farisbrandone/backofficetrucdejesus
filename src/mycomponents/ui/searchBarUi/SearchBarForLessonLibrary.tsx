import {
  ...
  requestToGetLessonLibraryDataBySearchValue,
} from "@/fakeData";
...
function SearchBarForLessonLibrary({
  placeholder,
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetLessonLibraryDataBySearchValue(
        searchValue
      );
...
export default SearchBarForLessonLibrary;
