import {
  AssetsDataType,
  requestToGetAssetsDataBySearchValue,
} from "@/fakeData";
...
function SearchBarForAssets({
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetAssetsDataBySearchValue(searchValue);
      setAssetsData([...data]);
...
export default SearchBarForAssets;
