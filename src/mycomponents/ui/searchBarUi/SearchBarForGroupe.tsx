import {
  GroupeDataType,
  requestToGetGroupeDataBySearchValue,
} from "@/fakeData";
...
function SearchBarForGroupe({
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetGroupeDataBySearchValue(searchValue);
      setGroupeData([...data]);
...
export default SearchBarForGroupe;
