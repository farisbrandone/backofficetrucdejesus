import {
  ClientDataType,
  requestToGetClientDataBySearchValue,
} from "@/fakeData";
...
function SearchBarForClient({
  ...
  const handleSubmitSearchValue = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await requestToGetClientDataBySearchValue(searchValue);
      setClientData([...data]);
...
export default SearchBarForClient;
