...
function CreerLessonLibrary() {
  ...
  const [urlLessonLibrary, setUrlLessonLibrarys] = useState("");
  ...
  const [shortDescriptionLessonLibrary, setShortDescriptionLessonLibrary] =
    useState("");
  const [textButtonLessonLibrary, setMotsDepasse] = useState("");

  const [typeLessonLibrary, setTypeLessonLibrary] = useState(lessonType);
  ...
  console.log(setTypeLessonLibrary);
  ...
  const handleUrlLessonLibrarys = (e: ChangeEvent<HTMLInputElement>) => {
    e.preventDefault();
    setUrlLessonLibrarys(() => e.target.value);
  ...
  const createNewLessonLibrary = async () => {
    ...
    <Fragment>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-[16px] sm:text-[18px]">
          ...
          >
            <p className="text-[14px] ">
              Sélectionner le type de lecons{" "}
            </p>
            <SelectTrigger
              className={` w-[180px] ${
            ...
            <SelectContent>
              <SelectGroup>
                <SelectLabel>Sélection du format de la lecons</SelectLabel>
                <SelectItem value="Vidéo">Format Vidéo</SelectItem>
          ...
          {typeLessonLibrary === "audio" && (
            <div className="space-y-2 ">
              <Label htmlFor="urlLessonLibrary">
                Inserer le fichier ou l'url de l'audio associé à la leçon{" "}
                <span className="text-[#e91e63]">*</span>
              </Label>
              <div className="flex items-center gap-2">
                <Input
                  ...
                  placeholder="Url de l'audio associé à la leçon"
                ...
                />
                <ButtonUploadFile
                  setImageUrl={setUrlLessonLibrarys}
                  setStateDownloadProps={setStateDownload}
                  stateDownloadProps={stateDownload}
                  name="leçons1"
          ...
          {typeLessonLibrary === "video" && (
            <div className="space-y-2 ">
              <Label htmlFor="urlLessonLibrary">
                Inserer le fichier ou l'url de la video associé à la leçon{" "}
                <span className="text-[#e91e63]">*</span>
              </Label>
              <div className="flex items-center gap-2">
                <Input
                  ...
                  name="urlLessonLibrary"
                  value={urlLessonLibrary}
                  placeholder="Url de la video associé à la leçon"
                  onChange={handleUrlLessonLibrarys}
                  disabled={stateDownload || startSending}
                  className={`w-[80%] ${
                    classUrlLessonLibrarys
        ...
        <CardFooter className="flex items-center gap-3 space-y-2">
          <Button
            disabled={stateDownload || startSending}
            onClick={createNewLessonLibrary}
          >
            Enregistrer
          </Button>
          <Button
...
export default CreerLessonLibrary;
