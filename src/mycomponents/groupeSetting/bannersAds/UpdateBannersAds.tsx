...
function UpdateBannersAds() {
  ...
  useEffect(() => {
    async function getData() {
      try {
        const data =
          await requestToGetAllUniversalDataWithId<BannersAdsDataType>(
            bannerId as string,
            "BannersAdsData"
          );
        setTitle(data.title);
      ...
      <Card>
        ...
        <CardContent className="space-y-2 flex-col gap-3 text-[16px] sm:text-[18px]">
          ...
          <div className="flex items-center gap-1">
            ...
            />
            <div className="flex items-center gap-1">
              <p className="-mr-3">Activation du Banner Ads</p>
...
export default UpdateBannersAds;
