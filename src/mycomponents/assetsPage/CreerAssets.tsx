...
function CreerAssets() {
  ...
  /* const handleDescriptionAssets = (
      e: ChangeEvent<HTMLTextAreaElement>
    ) => {
      e.preventDefault();
      setDescriptionAssets(() => e.target.value);
  ...
  /* const handleTypeAssetss = (value: string) => {
      setTypeAssets(value);
    }; */
        ...
        <CardContent className="space-y-2 text-[16px] sm:text-[18px]">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-1">
              <span className="icon-[fontisto--euro] text-xl mr-1"></span>
              <Input
                type="amountAssets"
                id="amountAssets"
                name="amountAssets"
